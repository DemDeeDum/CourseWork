namespace Hotel.DAL.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RoomClassId = c.Int(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.RoomClasses", t => t.RoomClassId, cascadeDelete: true)
                .Index(t => t.RoomClassId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Rooms", "RoomClassId", "dbo.RoomClasses");
            ...
            DropIndex("dbo.Rooms", new[] { "RoomClassId" });
