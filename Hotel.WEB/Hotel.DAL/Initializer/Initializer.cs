...
namespace Hotel.DAL.Initializer
{
    class ApplicationDbContextInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext db)
        {
            ...
            roleManager.Create(new IdentityRole("deleted")); //soft delete/ ban for users
            ...
            db.Bookings.Add(new Booking() //will be placed in paid bookings
            {
            ...
            db.Bookings.Add(new Booking() //will be placed in non-paid bookings
            {
            ...
            db.Bookings.Add(new Booking() //will be placed in finished
            {
                BeginningDate = DateTime.Today.AddDays(-10),
            ...
            db.Bookings.Add(new Booking() //will be deleted by destroying thread
            {
            ...
            //не выводить inass booked
            //менять имя пользователя
            //убирать админов кроме себя
            ...
            db.UnluckyRequests.Add(new UnluckyRequest() //will be deleted by destroying thread
            {
                User = user3,
                FinishDate = DateTime.Today.AddDays(7),
